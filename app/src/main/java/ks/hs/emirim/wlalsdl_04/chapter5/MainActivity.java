package ks.hs.emirim.wlalsdl_04.chapter5;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDog.setOnClickListener(btnLiear);
        btnCat.setOnClickListener(btnLiear);
        btnSnail.setOnClickListener(btnLiear);
    }

    View.OnClickListener btnLiear = new View.OnClickListener() {
        @Override
